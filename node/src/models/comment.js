...
const commentSchema = new mongoose.Schema({
    ...
    // Other alternative is just put here the nick and mail for the user to avoid lookup or populate when getting the comment.
    // But when a change is performed in user, these values have to be updated in every comment of the database
    user: {
...
function toResponse(document) {
    ...
    if (document instanceof Array) {
        ...
        let response = {};
        response.id = response.commentid.toString();
